...
typedef enum
{
    ...
    DRV_ETHER_EVENT_RESUME_CONNECT = (1 << 2),     ///< ethernet resume connected
    DRV_ETHER_EVENT_SUSPEND_DISCONNECT = (1 << 3), ///< ethernet suspend disconnected
} drvEthEvent_t;
...
struct drv_ether
{
    ...
    void *thread; //usb-ether thread id
#endif
};
