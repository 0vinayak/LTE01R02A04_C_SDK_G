...
#if defined(CONFIG_SOC_8910) || defined(CONFIG_SOC_8811) || defined(CONFIG_SOC_8821)
typedef struct
{
    uint32_t rxOvf : 1;
    uint32_t txTh : 1;
...
uint32_t drvSpiRWDmaIrq(drvSpiMaster_t *d, void *sendaddr, void *readaddr, uint32_t len);
