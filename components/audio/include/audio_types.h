...
typedef enum
{
    ...
    AUDEV_OUTPUT_BLUETOOTH = 3, ///< bluetooth
} audevOutput_t;
 ...
 */
extern const uint16_t gDtmfToneFreq[19][2];
...
typedef enum
{
    ...
    /**
     * Record for voice call. The recorded stream is only downlink channel.
     */
    AUDEV_RECORD_TYPE_VOICE_DL,
