...
void hal_speech_print_txzsp(CONST HAL_SPEECH_ENC_OUT_T *pushedTx);
void hal_speech_print_txbcpu(CONST HAL_SPEECH_ENC_OUT_T *pushedTx);

void hal_speech_print_rx(CONST HAL_SPEECH_DEC_IN_T *popedRx);
