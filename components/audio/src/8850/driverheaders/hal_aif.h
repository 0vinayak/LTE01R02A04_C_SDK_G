...
typedef enum
{
    HAL_AIF_CHANNEL_MONO_L = 1,
    HAL_AIF_CHANNEL_MONO_R = 2,
...
// enum: aud clk of chip output
typedef enum
{
    AUD_CLK_OUT_FREQ_26M = 0,
    AUD_CLK_OUT_FREQ_78M = 1,
    AUD_CLK_OUT_FREQ_133M = 2,
    AUD_CLK_OUT_FREQ_122_88M = 3,
    AUD_CLK_OUT_FREQ_167M = 4,
    AUD_CLK_OUT_FREQ_MAX
} AUD_CLK_FREQ_T;
...
PUBLIC VOID hal_AifSetI2sGpio(UINT32 i2sid);
#ifndef CONFIG_QUEC_PROJECT_FEATURE
PUBLIC VOID hal_AifClrI2sGpio(void);
#endif /* CONFIG_QUEC_PROJECT_FEATURE */
PUBLIC VOID hal_AudClockRequest(AUD_CLK_FREQ_T user, UINT16 clkdiv);
PUBLIC VOID hal_AudClockRelease(AUD_CLK_FREQ_T user);
PUBLIC VOID hal_CodecMClockRequest(AUD_CLK_FREQ_T user);
PUBLIC VOID hal_CodecMClockRelease(AUD_CLK_FREQ_T user);
#ifndef CONFIG_QUEC_PROJECT_FEATURE
PUBLIC VOID hal_AifSetPaGpio(void);
PUBLIC VOID hal_AifClrPaGpio(void);
PUBLIC VOID hal_AifSetGpio11(bool flag);
PUBLIC VOID hal_AifSetGpio0(bool flag);
PUBLIC VOID hal_AifSetGpio5(bool flag);
PUBLIC VOID hal_AifSetGpio6(bool flag);
PUBLIC VOID hal_AifSetGpio27(bool flag);
PUBLIC VOID hal_AifSetGpio26(bool flag);
PUBLIC VOID hal_AifSetGpio28(bool flag);
PUBLIC VOID hal_AifSetGpio30(bool flag);
#endif /* CONFIG_QUEC_PROJECT_FEATURE */
