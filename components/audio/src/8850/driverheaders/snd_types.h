...
typedef enum
{
    ...
    SND_BT_ALIGN_4BYTES = 0xF0000000
} SND_BT_WORK_MODE_T;

typedef enum
{
    SND_APP_MODE_VOICENB = 0x00000000,
    SND_APP_MODE_MUSIC = 0x00000001,
    SND_APP_MODE_RECORD = 0x00000002,
    SND_APP_MODE_FMPLAY = 0x00000003,
    SND_APP_MODE_FMRECORD = 0x00000004,
    SND_APP_MODE_VOICEWB = 0x00000005,
    SND_APP_MODE_TONEPLAY = 0x00000006,
    SND_APP_MODE_QTY = 0x00000007,
    SND_APP_ALIGN_4BYTES = 0xF0000000
} SND_APP_MODE_T;
// ============================================================================
// SND_SPK_LEVEL_T
// -----------------------------------------------------------------------------
...
typedef enum
{
    ...
    SND_SPK_ALIGN_4BYTES = 0xF0000000
} SND_SPK_LEVEL_T;
#else
typedef enum
{
...
typedef enum
{
    ...
    SND_MIC_ALIGN_4BYTES = 0xF0000000
} SND_MIC_LEVEL_T;
...
typedef enum
{
    ...
    SND_SIDE_ALIGN_4BYTES = 0xF0000000
} SND_SIDE_LEVEL_T;
#else
typedef enum
{
...
typedef enum
{
    ...
    SND_TONE_ALIGN_4BYTES = 0xF0000000
} SND_TONE_ATTENUATION_T;
