// TODO: make sure this file is in sync with snd_types.h
// also make sure the types are renamed in the files as soon as possible
// (ask romuald to add the proper sed command in here ;)
