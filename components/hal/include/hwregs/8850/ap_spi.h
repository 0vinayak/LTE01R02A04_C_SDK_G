...
#define hwp_apSpi ((HWP_AP_SPI_T *)REG_ACCESS_ADDRESS(REG_AP_SPI_BASE))
...
// spi_clkd
#define AP_SPI_SPI_CLKD(n) (((n)&0xffff) << 0)

// spi_ctl0
#define AP_SPI_NG_RX (1 << 0)
#define AP_SPI_NG_TX (1 << 1)
#define AP_SPI_CHNL_LEN(n) (((n)&0x1f) << 2)
#define AP_SPI_LSB (1 << 7)
#define AP_SPI_SPI_CSN_PRE(n) (((n)&0xf) << 8)
#define AP_SPI_IS_SCK_REV (1 << 13)
#define AP_SPI_SYNC_MD (1 << 14)
#define AP_SPI_SYNC_3WRD_POL (1 << 15)

// spi_ctl1
#define AP_SPI_S3W_POS(n) (((n)&0x1f) << 0)
#define AP_SPI_S3W_MD (1 << 5)
#define AP_SPI_CS_H_MD (1 << 6)
#define AP_SPI_S8_MD (1 << 7)
#define AP_SPI_SYNC_CSN_SEL(n) (((n)&0xf) << 8)
#define AP_SPI_IS_RXMD (1 << 12)
#define AP_SPI_IS_TXMD (1 << 13)
#define AP_SPI_DO_HOLD_EN(n) (((n)&0x3) << 14)

// spi_ctl2
#define AP_SPI_S3W_RD_STRT(n) (((n)&0x1f) << 0)
#define AP_SPI_IS_SLVD (1 << 5)
#define AP_SPI_DMA_EN (1 << 6)
#define AP_SPI_RX_ONLY_NHD (1 << 7)
#define AP_SPI_RX_DMA_SEL (1 << 8)
#define AP_SPI_TX_DMA_SEL (1 << 9)
#define AP_SPI_DMA_REQ_SEQ_SEL (1 << 10)

// spi_ctl3
#define AP_SPI_RXF_FULL_THRHLD(n) (((n)&0x1f) << 0)
#define AP_SPI_RXF_EMPTY_THRHLD(n) (((n)&0x1f) << 8)

// spi_ctl4
#define AP_SPI_BLOCK_NUM(n) (((n)&0x1ff) << 0)
#define AP_SPI_IS_RX_ONLY (1 << 9)
#define AP_SPI_SYNC_HALF (1 << 10)
#define AP_SPI_SYNC_CLKMASK_EN (1 << 11)
#define AP_SPI_PHS_DLY(n) (((n)&0x3) << 12)
#define AP_SPI_IS_FST (1 << 14)
#define AP_SPI_RX_ONLY_DO (1 << 15)

// spi_ctl5
#define AP_SPI_ITVL_NUM_SAM(n) (((n)&0xffff) << 0)

// spi_int_en
#define AP_SPI_RXF_FULL_INT_EN (1 << 0)
#define AP_SPI_RXF_EMPTY_INT_EN (1 << 1)
#define AP_SPI_TXF_FULL_INT_EN (1 << 2)
#define AP_SPI_TXF_EMPTY_EN (1 << 3)
#define AP_SPI_RX_OVF_INT_EN (1 << 4)
#define AP_SPI_TIME_OUT_INT_EN (1 << 5)
#define AP_SPI_RXF_R_FULL_INT_EN (1 << 6)
#define AP_SPI_TXF_W_EMPTY_INT_EN (1 << 7)
#define AP_SPI_TX_END_INT_EN (1 << 8)
#define AP_SPI_RX_END_INT_EN (1 << 9)

// spi_int_clr
#define AP_SPI_RXF_FULL_INT_CLR (1 << 0)
#define AP_SPI_RXF_EMPTY_INT_CLR (1 << 1)
#define AP_SPI_TXF_FULL_INT_CLR (1 << 2)
#define AP_SPI_TXF_EMPTY_INT_CLR (1 << 3)
#define AP_SPI_RX_OVF_INT_CLR (1 << 4)
#define AP_SPI_TIME_OUT_INT_CLR (1 << 5)
#define AP_SPI_TX_END_INT_CLR (1 << 8)
#define AP_SPI_RX_END_INT_CLR (1 << 9)

// spi_int_raw_sts
#define AP_SPI_RX_FULL_RAW_STS (1 << 0)
#define AP_SPI_RXF_EMPTY_RAW_STS (1 << 1)
#define AP_SPI_TXF_FULL_RAW_STS (1 << 2)
#define AP_SPI_TX_FIFO_EMPTY_W (1 << 3)
#define AP_SPI_RX_OVF_RAW_STS (1 << 4)
#define AP_SPI_TIME_OUT_RAW_STS (1 << 5)
#define AP_SPI_RXF_FULL_R (1 << 6)
#define AP_SPI_TXF_EMPTY_W (1 << 7)
#define AP_SPI_TX_END_IRQ (1 << 8)
#define AP_SPI_RX_END_IRQ (1 << 9)

// spi_int_mask_sts
#define AP_SPI_RXF_EMPTY_MASK_STS (1 << 1)
#define AP_SPI_TXF_FULL_MASK_STS (1 << 2)
#define AP_SPI_RX_OVF_MASK_STS (1 << 4)
#define AP_SPI_TIME_OUT_MASK_STS (1 << 5)
#define AP_SPI_RXF_FULL_MASK_STS (1 << 6)
#define AP_SPI_TXF_EMPTY_MASK_STS (1 << 7)
#define AP_SPI_TX_END_IRQ_MASK_STS (1 << 8)
#define AP_SPI_RX_END_IRQ_MASK_STS (1 << 9)

// spi_sts1
#define AP_SPI_RXF_RADDR(n) (((n)&0x1f) << 0)
#define AP_SPI_RXF_WADDR(n) (((n)&0x1f) << 8)

// spi_sts2
#define AP_SPI_RXF_FULL (1 << 0)
#define AP_SPI_RXF_EMPTY (1 << 1)
#define AP_SPI_TXF_FULL (1 << 2)
#define AP_SPI_TXF_EMPTY (1 << 3)
#define AP_SPI_RXF_REAL_FULL (1 << 4)
#define AP_SPI_RXF_REAL_EMPTY (1 << 5)
#define AP_SPI_TXF_REAL_FULL (1 << 6)
#define AP_SPI_TXF_REAL_EMPTY (1 << 7)
#define AP_SPI_BUSY (1 << 8)
#define AP_SPI_SPI_RXD (1 << 9)
#define AP_SPI_SPI_TXD (1 << 10)
#define AP_SPI_SPI_SCK (1 << 11)
#define AP_SPI_SPI_CS (1 << 12)

// spi_dspwait
#define AP_SPI_SPI_DSPWAIT(n) (((n)&0xf) << 0)
#define AP_SPI_RX_DATA_SWT(n) (((n)&0x3) << 4)
#define AP_SPI_TX_DATA_SWT(n) (((n)&0x3) << 6)

// spi_sts3
#define AP_SPI_RX_CNT(n) (((n)&0x1ff) << 0)

// spi_ctl6
#define AP_SPI_TXF_FULL_THRHLD(n) (((n)&0x1f) << 0)
#define AP_SPI_TXF_EMPTY_THRHLD(n) (((n)&0x1f) << 8)

// spi_sts4
#define AP_SPI_TXF_RADDR(n) (((n)&0x1f) << 0)
#define AP_SPI_TXF_WADDR(n) (((n)&0x1f) << 8)

// spi_fifo_rst
#define AP_SPI_SPI_FIFO_RST (1 << 0)

// spi_ctl7
#define AP_SPI_CSN_IE_CTL (1 << 0)
#define AP_SPI_CSN_I_SEL(n) (((n)&0x3) << 1)
#define AP_SPI_SPI_MODE(n) (((n)&0x7) << 3)
#define AP_SPI_TX_CMD_SET (1 << 6)
#define AP_SPI_SPI_TX_HLD_EN (1 << 7)
#define AP_SPI_SPI_RX_HLD_EN (1 << 8)
#define AP_SPI_DATA_IN_MODE (1 << 9)
#define AP_SPI_SPI_SLV_EN (1 << 10)
#define AP_SPI_SPI_SLV_SEL (1 << 11)
#define AP_SPI_RGB888_EN (1 << 12)
#define AP_SPI_RGB666_EN (1 << 13)
#define AP_SPI_RGB565_EN (1 << 14)
#define AP_SPI_DATA_LINE2_EN (1 << 15)

// spi_sts5
#define AP_SPI_CSN_IN_SYNC2 (1 << 0)
#define AP_SPI_CSN_IN_ERR_SYNC2 (1 << 4)

// spi_ctl8
#define AP_SPI_SPI_TX_DATA_LEN_H(n) (((n)&0xf) << 0)
#define AP_SPI_SPI_TX_DUMY_LEN(n) (((n)&0x3f) << 4)
#define AP_SPI_DATA_LINE2_SW (1 << 11)
#define AP_SPI_RGB_PIX_MODE (1 << 12)
#define AP_SPI_CD_DATA2_SEL (1 << 13)
#define AP_SPI_SPI_CD_BIT2 (1 << 14)
#define AP_SPI_SPI_CD_BIT (1 << 15)

// spi_ctl9
#define AP_SPI_SPI_TX_DATA_LEN_L(n) (((n)&0xffff) << 0)

// spi_ctl10
#define AP_SPI_SPI_RX_DATA_LEN_H(n) (((n)&0xf) << 0)
#define AP_SPI_SPI_RX_DUMY_LEN(n) (((n)&0x3f) << 4)

// spi_ctl11
#define AP_SPI_SPI_RX_DATA_LEN_L(n) (((n)&0xffff) << 0)

// spi_ctl12
#define AP_SPI_SW_RX_REQ (1 << 0)
#define AP_SPI_SW_TX_REQ (1 << 1)

// spi_sts6
#define AP_SPI_SPI_STS6_TX_DATA_CNT(n) (((n)&0xffff) << 0)

// spi_sts7
#define AP_SPI_SPI_STS7_TX_DATA_CNT(n) (((n)&0xf) << 0)
#define AP_SPI_TX_DUMMY_CNT(n) (((n)&0x3f) << 10)

// spi_sts8
#define AP_SPI_SPI_STS8_RX_DATA_CNT(n) (((n)&0xffff) << 0)

// spi_sts9
#define AP_SPI_SPI_STS9_RX_DATA_CNT(n) (((n)&0xf) << 0)
#define AP_SPI_RX_DUMMY_CNT(n) (((n)&0x3f) << 10)

// spi_version
#define AP_SPI_SPI_VERSION(n) (((n)&0xffff) << 0)
