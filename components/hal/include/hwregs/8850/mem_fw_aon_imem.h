...
#ifndef _MEM_FW_AON_IMEM_H_
#define _MEM_FW_AON_IMEM_H_

// Auto generated by dtools(see dtools.txt for its version).
// Don't edit it manually!

#define REG_MEM_FW_AON_IMEM_BASE (0x51312000)
...
} HWP_MEM_FW_AON_IMEM_T;

#define hwp_memFwAonImem ((HWP_MEM_FW_AON_IMEM_T *)REG_ACCESS_ADDRESS(REG_MEM_FW_AON_IMEM_BASE))
...
typedef union {
    ...
    struct
    {
        uint32_t port0_default_r_addr_0 : 7; // [6:0]
        uint32_t __31_7 : 25;                // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_PORT0_DEFAULT_R_ADDR_0_T;
...
typedef union {
    ...
    struct
    {
        uint32_t port0_default_w_addr_0 : 7; // [6:0]
        uint32_t __31_7 : 25;                // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_PORT0_DEFAULT_W_ADDR_0_T;
...
} REG_MEM_FW_AON_IMEM_CLK_GATE_BYPASS_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_W_EN_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_W_CLR_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_W_RAW_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_W_FIN_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_R_EN_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_R_CLR_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_R_RAW_T;
...
} REG_MEM_FW_AON_IMEM_PORT_INT_R_FIN_T;
...
typedef union {
    ...
    struct
    {
        uint32_t w_addr_0 : 7; // [6:0], read only
        uint32_t __31_7 : 25;  // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_PORT_0_W_DEBUG_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_PORT_0_W_DEBUG_ID_T;
...
typedef union {
    ...
    struct
    {
        uint32_t r_addr_0 : 7; // [6:0], read only
        uint32_t __31_7 : 25;  // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_PORT_0_R_DEBUG_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_PORT_0_R_DEBUG_ID_T;
...
typedef union {
    ...
    struct
    {
        uint32_t first_addr : 7; // [6:0]
        uint32_t __31_7 : 25;    // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_SEG_DEFAULT_FIRST_ADDR_T;
...
typedef union {
    ...
    struct
    {
        uint32_t last_addr : 7; // [6:0]
        uint32_t __31_7 : 25;   // [31:7]
    } b;
} REG_MEM_FW_AON_IMEM_SEG_DEFAULT_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_0_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_0_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_1_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_1_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_2_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_2_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_3_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_3_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_4_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_4_LAST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_5_FIRST_ADDR_T;
...
} REG_MEM_FW_AON_IMEM_SEG_5_LAST_ADDR_T;

// port0_default_r_addr_0
#define MEM_FW_AON_IMEM_PORT0_DEFAULT_R_ADDR_0(n) (((n)&0x7f) << 0)

// port0_default_w_addr_0
#define MEM_FW_AON_IMEM_PORT0_DEFAULT_W_ADDR_0(n) (((n)&0x7f) << 0)

// clk_gate_bypass
#define MEM_FW_AON_IMEM_CLK_GATE_BYPASS (1 << 0)
#define MEM_FW_AON_IMEM_FW_RESP_EN (1 << 1)

// port_int_w_en
#define MEM_FW_AON_IMEM_PORT_0_W_EN (1 << 0)

// port_int_w_clr
#define MEM_FW_AON_IMEM_PORT_0_W_CLR (1 << 0)

// port_int_w_raw
#define MEM_FW_AON_IMEM_PORT_0_W_RAW (1 << 0)

// port_int_w_fin
#define MEM_FW_AON_IMEM_PORT_0_W_FIN (1 << 0)

// port_int_r_en
#define MEM_FW_AON_IMEM_PORT_0_R_EN (1 << 0)

// port_int_r_clr
#define MEM_FW_AON_IMEM_PORT_0_R_CLR (1 << 0)

// port_int_r_raw
#define MEM_FW_AON_IMEM_PORT_0_R_RAW (1 << 0)

// port_int_r_fin
#define MEM_FW_AON_IMEM_PORT_0_R_FIN (1 << 0)

// port_0_w_debug_addr
#define MEM_FW_AON_IMEM_W_ADDR_0(n) (((n)&0x7f) << 0)

// port_0_w_debug_id
#define MEM_FW_AON_IMEM_W_ID_0(n) (((n)&0xff) << 0)

// port_0_r_debug_addr
#define MEM_FW_AON_IMEM_R_ADDR_0(n) (((n)&0x7f) << 0)

// port_0_r_debug_id
#define MEM_FW_AON_IMEM_R_ID_0(n) (((n)&0xff) << 0)

// seg_default_first_addr
#define MEM_FW_AON_IMEM_FIRST_ADDR(n) (((n)&0x7f) << 0)

// seg_default_last_addr
#define MEM_FW_AON_IMEM_LAST_ADDR(n) (((n)&0x7f) << 0)
