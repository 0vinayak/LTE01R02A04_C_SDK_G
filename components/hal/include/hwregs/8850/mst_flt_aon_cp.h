...
#ifndef _MST_FLT_AON_CP_H_
#define _MST_FLT_AON_CP_H_

// Auto generated by dtools(see dtools.txt for its version).
// Don't edit it manually!

#define REG_MST_FLT_AON_CP_BASE (0x51303000)
...
} HWP_MST_FLT_AON_CP_T;

#define hwp_mstFltAonCp ((HWP_MST_FLT_AON_CP_T *)REG_ACCESS_ADDRESS(REG_MST_FLT_AON_CP_BASE))
...
} REG_MST_FLT_AON_CP_MST_FILTER_INT_EN_T;
...
} REG_MST_FLT_AON_CP_MST_FILTER_INT_RAW0_T;
...
} REG_MST_FLT_AON_CP_MST_FILTER_INT_STATUS0_T;
...
} REG_MST_FLT_AON_CP_MST_FILTER_INT_CLR_T;
...
} REG_MST_FLT_AON_CP_MST_FILTER_DEBUG_REG2_T;
...
} REG_MST_FLT_AON_CP_MST_FILTER_RESP_T;

// mst_filter_int_en
#define MST_FLT_AON_CP_MST_FILTER_INT_EN (1 << 0)

// mst_filter_int_raw0
#define MST_FLT_AON_CP_MST_FILTER_INT_RAW0 (1 << 0)

// mst_filter_int_status0
#define MST_FLT_AON_CP_MST_FILTER_INT_STATUS0 (1 << 0)

// mst_filter_int_clr
#define MST_FLT_AON_CP_MST_FILTER_INT_CLR (1 << 0)

// mst_filter_debug_reg2
#define MST_FLT_AON_CP_MST_FILTER_DEBUG_HAUSER(n) (((n)&0xff) << 0)
#define MST_FLT_AON_CP_MST_FILTER_DEBUG_HWRITE (1 << 8)

// mst_filter_resp
#define MST_FLT_AON_CP_MST_FILTER_RESP_EN (1 << 0)

#endif // _MST_FLT_AON_CP_H_
