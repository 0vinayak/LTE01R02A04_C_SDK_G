 ...
 */
#define CONFIG_QL_PROJECT_VENDOR_CHIP_DEF "UIS8850CM"

/**
 * Specify Project Main Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_EC200G

/**
 * Specify Project Sub Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_SUB_CN_GK

/**
 * Specify Project FULL Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_EC200G_CN_GK
...
/**
 * whether to specify usb host MASS Storage feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_USB_HOST_UDISK */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_BT

/**
 * whether to specify BLE_GATT feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_BLE_GATT
...
/**
 * whether to specify (BT_BLE_PACK=1:FR8003A/2:FR3036D) feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_BT_BLE_PACK 1
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_GNSS
 ...
 * whether to specify HD_GNSS feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_HD_GNSS
 ...
 * whether to specify AUDIO feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_AUDIO_RECORD
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_TTS
 ...
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_EXT_NOR_SFFS_MOUNT */
...
/**
 * whether to specify KWS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_KWS */

/**
 * whether to specify PROFILE feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PROFILE */

/**
 * whether to specify PWM AUDIO feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO */

/**
 * whether to specify PWM AUDIO DECODE feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO_DEC */

/**
 * whether to specify PWM AUDIO DECODE MP3 feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO_DEC_MP3 */

/**
 * whether to specify PWM AUDIO DECODE AMR feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO_DEC_AMR */

/**
 * whether to specify QuecScan feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_QUECSCAN */

/**
 * whether to specify SLAS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_SLAS */

/**
 * whether to specify PWM AUDIO DECODE AWB feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO_DEC_AWB */

/**
 * whether to specify PWM AUDIO DECODE WAV feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_PWM_AUDIO_DEC_WAV */
