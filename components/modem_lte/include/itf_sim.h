...
#ifdef SIM_CACHING
#define SIM_SAVE_FILE_REQ         			( HVY_SIM + 63 )
#endif
#define SIM_SEND_CMD_REQ         			( HVY_SIM + 64 )
#define SIM_MANAGE_CHANNEL_REQ	        	( HVY_SIM + 65 )
#define SIM_NEW_STATUS_REQ         			( HVY_SIM + 66 )
#define SIM_NEW_SEND_CMD_REQ         		( HVY_SIM + 67 )
#define SIM_SUSPEND_REQ         			( HVY_SIM + 68 )
#define SIM_RESUME_REQ         				( HVY_SIM + 69 )
...
#define SIM_SEND_CMD_CNF         			( HVY_SIM + 56 )
#define SIM_MANAGE_CHANNEL_CNF      		( HVY_SIM + 57 )
#define SIM_NEW_STATUS_CNF           		( HVY_SIM + 58 )                  
#define SIM_RETRY_TIMER_EXP     		(( HVY_SIM + 59 )| SXS_TIMER_EVT_ID )                     
#define SIM_NEW_VERIFY_CHV_CNF        		( HVY_SIM + 60 )
#define SIM_NEW_UNBLOCK_CHV_CNF        		( HVY_SIM + 61 )
#define SIM_SUSPEND_CNF           			( HVY_SIM + 62 )
#define SIM_RESUME_CNF           			( HVY_SIM + 63 )


//CATM 4G new add
#define SIM_RUN_UMTS_ALGO_CNF_4G 		(( HVY_SIM + 54 )  | 0x80000000)
#define SIM_READ_BINARY_CNF_4G      		(( HVY_SIM + 33 ) | 0x80000000)            
#define SIM_UPDATE_BINARY_CNF_4G   		(( HVY_SIM + 34 ) | 0x80000000)                    
#define SIM_READ_RECORD_CNF_4G        		(( HVY_SIM + 35 ) | 0x80000000)                    
#define SIM_UPDATE_RECORD_CNF_4G      		(( HVY_SIM + 36 ) | 0x80000000)                   
#define SIM_ELEM_FILE_STATUS_CNF_4G  		(( HVY_SIM + 47 ) | 0x80000000)            


#ifdef SIM_CACHING
#define SIM_RE_POWER_ON_IND      		( HVY_SIM + 90 )
#define SIM_SAVE_FILE_CNF      			( HVY_SIM + 91 )
#endif
...
//ISIM file
#define    USIM_EF_IMPI			213
#define    USIM_EF_IMPU			214
#define    USIM_EF_DOMAIN		215

//UIM file
#define    UIM_EF_IMSI_M		216
#define    UIM_EF_IMSI_T		217

#define    USIM_EF_UMPC			218

//files under DF HNB
#define    USIM_EF_ACSGL		219
#define    USIM_EF_CSGT			220
#define    USIM_EF_HNBN			221
#define    USIM_EF_OCSGL		222
#define    USIM_EF_OCSGT		223
#define    USIM_EF_OHNBN		224

#define    NB_ELEM_FILE			225

#define    EF_ACSGL_STATUS      (0x01 << 0)
#define    EF_OCSGL_STATUS      (0x01 << 1)
#define    EF_HNBN_STATUS       (0x01 << 2)
#define    EF_OHNBN_STATUS      (0x01 << 3)
...
// phonebook under ADF USIM, USIM local phonebook                        
    ...
    {{0x7F,0xFF},{0x6F,0x02}},  //    USIM_EF_IMPI			213
    {{0x7F,0xFF},{0x6F,0x04}},  //    USIM_EF_IMPU			214
    {{0x7F,0xFF},{0x6F,0x03}},   //    USIM_EF_DOMAIN		215

    {{0x7F,0x25},{0x6F,0x22}},  //    UIM_EF_IMSI_M			216
    {{0x7F,0x25},{0x6F,0x23}},  //    UIM_EF_IMSI_T			217
    {{0x3F,0x00},{0x2F,0x08}},  //    USIM_EF_UMPC			218

    //files under DF HNB
    {{0x5F,0x50},{0x4F,0x81}},  // USIM_EF_ACSGL			219
    {{0x5F,0x50},{0x4F,0x82}},  // USIM_EF_CSGT				220
    {{0x5F,0x50},{0x4F,0x83}},  // USIM_EF_HNBN				221
    {{0x5F,0x50},{0x4F,0x84}},  // USIM_EF_OCSGL			222
    {{0x5F,0x50},{0x4F,0x85}},  // USIM_EF_OCSGT			223
    {{0x5F,0x50},{0x4F,0x86}}   // USIM_EF_OHNBN			224
};
#else
;
#endif
...
// file undre MF for esim
    ...
    {0x2F,0x08},					//    USIM_EF_UMPC			218

//files under DF HNB
    {0x7F,0xFF,0x5F,0x50,0x4F,0x81},   //    USIM_EF_ACSGL		219
    {0x7F,0xFF,0x5F,0x50,0x4F,0x82},   //    USIM_EF_CSGT		220
    {0x7F,0xFF,0x5F,0x50,0x4F,0x83},   //    USIM_EF_HNBN		221
    {0x7F,0xFF,0x5F,0x50,0x4F,0x84},   //    USIM_EF_OCSGL		222
    {0x7F,0xFF,0x5F,0x50,0x4F,0x85},   //    USIM_EF_OCSGT		223
    {0x7F,0xFF,0x5F,0x50,0x4F,0x86}    //    USIM_EF_OHNBN		224
}
;
#else
;
...
#define RESET_SUCCESS_SOFTSIM   5
...
typedef struct
{
  u8 Sw1;
  u8 Sw2;
}sim_NewVerifyCHVCnf_t;

typedef struct
{
  u8 Sw1;
  u8 Sw2;
}sim_NewUnblockCHVCnf_t;
