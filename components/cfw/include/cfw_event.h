...
#define EV_CFW_SIM_RSP_EX_BASE (950)
#define EV_CFW_SIM_RSP_EX_END_ (1000)
...
#define EV_CFW_EMOD_BASE (1450)
#define EV_CFW_EMOD_END_ (1500)
#define EV_CFW_RF_LTE_FRE_PWR_RSP (EV_CFW_EMOD_BASE + 1)
#define EV_CFW_RF_LTE_BAND_PWR_RSP (EV_CFW_EMOD_BASE + 2)

//8850CM positioning abritration module handshake lte stack
#define EV_CFW_PAM_HSL_BASE (1500) //HandShakeLte
#define EV_CFW_PAM_HSL_END_ (1550)

#define EV_CFW_PAM_GNSS_HSL_START_RSP (EV_CFW_PAM_HSL_BASE + 1)
#define EV_CFW_PAM_GNSS_HSL_STOP_RSP (EV_CFW_PAM_HSL_BASE + 2)
#define EV_CFW_PAM_GNSS_HSL_ABORT_IND (EV_CFW_PAM_HSL_BASE + 3)

#define EV_CFW_PAM_WIFISCAN_HSL_START_RSP (EV_CFW_PAM_HSL_BASE + 4)
#define EV_CFW_PAM_WIFISCAN_HSL_STOP_RSP (EV_CFW_PAM_HSL_BASE + 5)
#define EV_CFW_PAM_WIFISCAN_HSL_ABORT_IND (EV_CFW_PAM_HSL_BASE + 6)
#define EV_CFW_PAM_WIFISCAN_RESULT_RSP (EV_CFW_PAM_HSL_BASE + 7)
#define EV_CFW_PAM_GNSS_RECOVERY_IND (EV_CFW_PAM_HSL_BASE + 8)
#define EV_CFW_PAM_GNSS_LTE_PRIORITY_RSP (EV_CFW_PAM_HSL_BASE + 9)
#define EV_CFW_WIFI_SENTEST_RSP (EV_CFW_PAM_HSL_BASE + 10)

#define EV_AT_PAM_AGNSS_IND (EV_CFW_PAM_HSL_BASE + 11)
#define EV_AT_PAM_GNSS_SLEEP_IND (EV_CFW_PAM_HSL_BASE + 12)
#define EV_AT_PAM_OUTPUT_INFO_IND (EV_CFW_PAM_HSL_BASE + 13)
#define EV_AT_PAM_DATA_SOCKET_IND (EV_CFW_PAM_HSL_BASE + 14)
#define EV_AT_PAM_POSITION_INFO_IND (EV_CFW_PAM_HSL_BASE + 15)

#define EV_PAM_STARTMODE_AND_AGNSS_IND (EV_CFW_PAM_HSL_BASE + 20)

#define EV_CFW_IND_BASE (5000)
#define EV_CFW_IND_END_ (5090)
...
#define QL_SMTP_EVENT  11012
#endif

#ifdef CONFIG_QUEC_PROJECT_FEATURE_SMS_AT
#define QL_SMS_EVENT    11013
#endif

#ifdef CONFIG_QUEC_PROJECT_FEATURE_SNMP_AT
#define QL_SNMP_EVENT    11014
#endif

#ifdef __QUEC_OEM_VER_AC__
#define QL_TCPIP_AC_EVENT   11015
#endif

#define QL_NETDEV_EVENT 11300

#define QL_PPP_EVENT 11301

#define QL_L2TP_EVENT 11305
...
#define QL_DATACALL_EVENT 11340
...
#define EV_DM_DAEMON_IND (EV_DM_BASE + 2)   // 52
...
#define EV_SWITCH_GSM_LTE_FIX (EV_DM_BASE + 48)
...
#define EV_CFW_GPRS_AUTO_ACT_IND (EV_CFW_IND_BASE + 70)
#define EV_CFW_TCPIP_DATA_RF_ACKED_IND (EV_CFW_IND_BASE + 71)
#define EV_CFW_GPRS_APPSN_IND (EV_CFW_IND_BASE + 72)
#define EV_CFW_SMS_CONCAT_MESSAGE_IND (EV_CFW_IND_BASE + 73)
#define EV_CFW_CC_DTMF_KEY_IND (EV_CFW_IND_BASE + 74)
#if defined RPM_SUPPORT || defined(CONFIG_NBIOT_RPM_SUPPORT)
#define EV_CFW_RPM_REBOOT_IND (EV_CFW_IND_BASE + 75)
#endif
#define EV_CFW_ERRC_CONNSTATUS_V2_IND (EV_CFW_IND_BASE + 76)
#if defined(CONFIG_SOC_8910) || defined(CONFIG_SOC_8850)
#define EV_CFW_BSIC_PCI_STATUS_IND (EV_CFW_IND_BASE + 77)
#define EV_CFW_ENG_EVENT_RPT_IND (EV_CFW_IND_BASE + 78)
#define EV_CFW_ENG_STATIS_RPT_IND (EV_CFW_IND_BASE + 79)
#define EV_CFW_GSM_RACH_RESULT_IND (EV_CFW_IND_BASE + 80)
#define EV_CFW_ENG_STATIS_RPT_EL1_IND (EV_CFW_IND_BASE + 81)
#endif
#define EV_CFW_GPRS_NONIP_ACT_IND (EV_CFW_IND_BASE + 82)
#if defined(CONFIG_SOC_8910) || defined(CONFIG_SOC_8850)
#define EV_CFW_ENG_EVENT_RPT_V2_IND (EV_CFW_IND_BASE + 83)
#define EV_CFW_ENG_STATIS_RPT_V2_IND (EV_CFW_IND_BASE + 84)
#define EV_CFW_NW_EMM_FAILED_PROCEDURE_IND (EV_CFW_IND_BASE + 85)
#endif

#define EV_CFW_UART_BAUD_CHANGE_NOTIFY_IND (EV_CFW_IND_BASE + 87)
#define EV_CFW_SMS_CLEAR_UNSOLICITED_RESULT_CODES_IND (EV_CFW_IND_BASE + 88)

#if defined(CONFIG_SOC_8910) || defined(CONFIG_SOC_8850)
#define EV_CFW_ENG_EVENT_RPT_REDIRECT_IND (EV_CFW_IND_BASE + 89)
#define EV_CFW_ENG_EVENT_RPT_GSMTOLTE_IND (EV_CFW_IND_BASE + 90)
#define EV_CFW_ENG_EVENT_RPT_V3_IND (EV_CFW_IND_BASE + 91)
#endif

#define EV_CFW_GSM_NET_REJCAUSE_IND (EV_CFW_IND_BASE + 93)
//
// Emulator Event
//
...
#define EV_CFW_NW_JAMMING_RSSI_RSP (EV_CFW_NW_RSP_BASE + 19)
#define EV_CFW_BLKLIST_GSM_PARAM_GET_IND (EV_CFW_NW_RSP_BASE + 20)
#define EV_CFW_NW_NET_DL_PSM_PARAM_RSP (EV_CFW_NW_RSP_BASE + 21)
#define EV_CFW_BLKLIST_LTE_PARAM_GET_IND (EV_CFW_NW_RSP_BASE + 22)
#define EV_CFW_ERRC_IDL_MEAS_OFFSET_READ_RSP (EV_CFW_NW_RSP_BASE + 23)
#define EV_CFW_NW_GET_FREQSCAN_V2_RSP (EV_CFW_NW_RSP_BASE + 24)
#define EV_CFW_NW_CSG_LIST_RSP (EV_CFW_NW_RSP_BASE + 25)
#define EV_CFW_NW_IMS_DEREGISTER_RSP (EV_CFW_NW_RSP_BASE + 26)
#define EV_CFW_NW_GET_T3245_LENGTH_RSP (EV_CFW_NW_RSP_BASE + 27)
...
#define EV_TCPIP_CFW_GPRS_RFACK (EV_CFW_GPRS_RSP_BASE + 11)
#define EV_TCPIP_CFW_GPRS_ACTED (EV_CFW_GPRS_RSP_BASE + 12)
#define EV_TCPIP_CFW_GPRS_DEACTED (EV_CFW_GPRS_RSP_BASE + 13)
#define EV_TCPIP_UNETLOG_IND (EV_CFW_GPRS_RSP_BASE + 14)
#define EV_TCPIP_CFW_GPRS_IPV6_PREFERED (EV_CFW_GPRS_RSP_BASE + 15)
//
// CC Response Event
//
...
#define EV_CFW_SS_SET_CLIP_RSP (EV_CFW_SS_RSP_BASE + 18)
#define EV_CFW_SS_SET_CLIR_RSP (EV_CFW_SS_RSP_BASE + 19)
#define EV_CFW_SS_SET_COLP_RSP (EV_CFW_SS_RSP_BASE + 20)
#define EV_CFW_SS_SET_COLR_RSP (EV_CFW_SS_RSP_BASE + 21)
#if 1 //NBIOT_POSITION_SUPPORT
#define EV_CFW_LCS_MTLR_IND (EV_CFW_SS_RSP_BASE + 15)
#define EV_CFW_LCS_MOLR_RES (EV_CFW_SS_RSP_BASE + 16)
#define EV_CFW_LCS_MOLR_ERR (EV_CFW_SS_RSP_BASE + 17)
#endif //NBIOT_POSITION_SUPPORT
//
// SIM Response Event
//
...
#define EV_CFW_SIM_SET_SUSPEND_RSP (EV_CFW_SIM_RSP_BASE + 67)
#define EV_CFW_SIM_SET_RESUME_RSP (EV_CFW_SIM_RSP_BASE + 68)
#define EV_CFW_SAT_TERMINAL_RESPONSE_RSP (EV_CFW_SIM_RSP_BASE + 69)
#define EV_CFW_SAT_TERMINAL_ENVELOPE_RSP (EV_CFW_SIM_RSP_BASE + 70)

#define EV_CFW_SIM_UPDATE_SAVE_FILE_RSP (EV_CFW_SIM_RSP_EX_BASE + 1)

//
// SMS Response Event.
//
#define EV_CFW_SMS_DELETE_MESSAGE_RSP (EV_CFW_SMS_RSP_BASE + 1) // 761
