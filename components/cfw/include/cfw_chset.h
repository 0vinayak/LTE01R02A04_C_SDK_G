...
size_t cfwDecode7Bit(const void *src, void *dst, size_t size);
size_t cfwEncode7Bit(const void *src, void *dst, size_t size);
...
int cfwBcdToString(const void *src, size_t size, void *dst);
int cfwStringToBcd(const void *src, size_t size, void *dst);
int _asciiToBcd(char c);
