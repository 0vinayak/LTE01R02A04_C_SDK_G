...
#ifdef CONFIG_QUEC_PROJECT_FEATURE
extern uint8_t fat_disk_register_device(blockDevice_t *dev);
extern bool fat_disk_unregister_device(uint8_t idx);
extern int8_t ql_fat_get_volume_by_bdev(blockDevice_t *dev);
extern blockDevice_t *ql_fat_get_bdev_by_volume(int8_t volume);
#endif
