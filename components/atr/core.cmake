...
set(import_lib ${out_lib_dir}/libatr.a)
configure_file(${ql_dm_dir}/libatr.a ${import_lib} COPYONLY)
add_app_libraries(${import_lib})
add_library(atr STATIC IMPORTED GLOBAL)
set_target_properties(atr PROPERTIES IMPORTED_LOCATION ${import_lib} INTERFACE_INCLUDE_DIRECTORIES ${CMAKE_CURRENT_SOURCE_DIR}/include)

if(NOT CONFIG_QUEC_PROJECT_FEATURE_ATC_PARSE)
