 ...
 */
#define ECPARAMS    MBEDTLS_ECP_DP_SM2256
...
int main( int argc, char *argv[] )
{
    ...
    if( ( ret = mbedtls_ecdsa_sm2_write_signature( &ctx_sign, MBEDTLS_MD_SHA256,
                                       hash, sizeof( hash ),
                                       sig, &sig_len,
                                       mbedtls_ctr_drbg_random, &ctr_drbg ) ) != 0 )
    {
    ...
    if( ( ret = mbedtls_ecdsa_sm2_read_signature( &ctx_verify,
                                      hash, sizeof( hash ),
                                      sig, sig_len ) ) != 0 )
    {
