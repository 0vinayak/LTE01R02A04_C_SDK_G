...
#define TEST_SETUP(group) OSI_EXTERN_C void TEST_##group##_SETUP(void);\
    void TEST_##group##_SETUP(void)

#define TEST_TEAR_DOWN(group) OSI_EXTERN_C void TEST_##group##_TEAR_DOWN(void);\
    void TEST_##group##_TEAR_DOWN(void)


#define TEST(group, name) \
    OSI_EXTERN_C void TEST_##group##_##name##_(void);\
    OSI_EXTERN_C void TEST_##group##_##name##_run(void);\
...
#define TEST_GROUP_RUNNER(group)\
    OSI_EXTERN_C void TEST_##group##_GROUP_RUNNER(void);\
