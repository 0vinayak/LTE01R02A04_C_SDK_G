...
typedef enum
{
    QL_BT_AUD_AVRCP_MSG = 0xA500,//模块作为耳机角色，需要切换上下曲命令
    QL_BT_AUD_A2DP_MSG,//模块作为耳机角色，接收到声音数据需要播放
    QL_BT_AUD_A2DP_MSG_SRC,//模块作为手机角色有声音数据需要传到耳机端
} QL_BT_AUDIO_MSG_E;
...
typedef enum
{
    QL_BTA2DP_MODE_NORMAL,     //播放本地音频无法打断蓝牙音频播放
    QL_BTA2DP_MODE_ALLOW_INT,  //播放本地音频可以打断蓝牙音频播放
    QL_BTA2DP_MODE_MAX,
}ql_bta2dp_mode_e;

typedef struct
{
    ql_bta2dp_mode_e mode;
}ql_bt_a2dp_audio_cfg_t;
/*========================================================================
 *  function Definition
 *========================================================================*/
...
/*****************************************************************
* Function: ql_classic_bt_get_peer_dev_info
*
* Description:
*   获取已连接的对端设备信息
* 
* Parameters:
*        bt_peer_dev_info [in]   对端设备信息
*
* Return:ql_errcode_bt_e
*
*****************************************************************/
ql_errcode_bt_e ql_classic_bt_get_peer_dev_info(ql_bt_peer_dev_info_s *bt_peer_dev_info);
...
/*****************************************************************
* Function: ql_ble_expadv_set_data
*
* Description:
