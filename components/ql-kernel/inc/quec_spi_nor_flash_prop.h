...
typedef struct 
{
    ...
    uint32_t eb_size;                           //flash erase block size, general use 0x1000(4KB),in special cases,use 0x8000(32KB) to reduce the formatting time of the file system
