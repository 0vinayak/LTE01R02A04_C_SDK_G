...
typedef enum{
	QL_PING_OK                         = 0,
	QL_PING_ERR_UNKNOW       		   = (QL_COMPONENT_LWIP_SOCKET << 16) | 550	/* Unknow ERROR   */,
    ...
    QL_PING_ERR_SOCKET_WRITE_FAILURE   = (QL_COMPONENT_LWIP_SOCKET << 16) | 558	/* Socket write failed   */,
	QL_PING_ERR_DNS_FAILURE            = (QL_COMPONENT_LWIP_SOCKET << 16) | 565	/* DNS parse failed     */,
	QL_PING_ERR_SOCKET_CONNECT_FAILURE = (QL_COMPONENT_LWIP_SOCKET << 16) | 566	/* Socket connect failed   */,
