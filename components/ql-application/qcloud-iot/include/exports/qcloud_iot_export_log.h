...
#define Log_d(msg, ...) QL_LOG(QL_LOG_LEVEL_INFO,"qcloud ", msg, ##__VA_ARGS__)
#define Log_i(msg, ...) QL_LOG(QL_LOG_LEVEL_INFO, "qcloud ", msg, ##__VA_ARGS__)
#define Log_w(msg, ...) QL_LOG(QL_LOG_LEVEL_WARN, "qcloud ", msg, ##__VA_ARGS__)
#define Log_e(msg, ...) QL_LOG(QL_LOG_LEVEL_ERROR,"qcloud ", msg, ##__VA_ARGS__)
