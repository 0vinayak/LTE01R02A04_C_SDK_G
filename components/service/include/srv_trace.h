...
void srv_fsTraceTimeStamp(void);
#ifdef CONFIG_FS_UNET_LOG_ENABLE

//STATE | ACC_TYPE | SEC_TYPE | PERIOD

#define STATE_OFFSET 7
#define ACC_TYPE_OFFSET 6
#define SEC_TYPE_OFFSET 5
#define PERIOD_OFFSET 4

#define AT_NETLOG 0x9F
#define STATE_MASK 0x80
#define ACC_TYPE_MASK 0x40

#define AT_NETLOGCFG 0x7F
#define SEC_TYPE_MASK 0x20
#define PERIOD_MASK 0x1f
void srvFstrace_UnetLog_Init(unsigned option);
void srvFstrace_UnetLog_SaveLogContext(uint8_t nSim, void *cxt);
void srvFstrace_UnetLog_SentCPExceptionLogFile(void *param);
typedef void (*srvFstrace_Send_Rsp_t)(void *pRsp);
#endif
OSI_EXTERN_C_END
#endif
