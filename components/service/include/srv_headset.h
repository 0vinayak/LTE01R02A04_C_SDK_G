...
typedef void (*srvHeadsetNotifyCB_t)(bool connected);
bool srvheadsetDetectRegister(srvHeadsetNotifyCB_t cb);
void prvSetInOutPath(drvHeadsetNotifyMsg_t id, uint32_t param);
OSI_EXTERN_C_END
