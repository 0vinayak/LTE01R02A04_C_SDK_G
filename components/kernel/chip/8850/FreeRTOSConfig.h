...
//  <i> Default: 1000
#define configTICK_RATE_HZ                      ((TickType_t)CONFIG_KERNEL_TICK_HZ) //Note: This macro does not allow modification!!!!
...
extern unsigned char ql_unique_interrupt_priorities;
extern unsigned char ql_max_api_call_interrupt_priority;
#endif

#define configUSE_NEWLIB_REENTRANT              1

#ifdef CONFIG_QUEC_PROJECT_FEATURE
//展锐已使用1个数组元素,下标使用宏 OSI_THREAD_LOCAL_EVENTQUEUE_ID;
//预留2个给展锐;
//quectel使用一个数组元素,下标使用宏 OSI_THREAD_LOCAL_USERDATA_ID
