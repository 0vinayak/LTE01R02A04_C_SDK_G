...
{
    OSI_LOGI(0x100090c0, "heap start/%p end/%p tail/%p",
...
OSI_WEAK void *malloc(unsigned size) { return _heap_malloc(gDefaultHeap, size); }
OSI_WEAK void *calloc(unsigned nmemb, unsigned size) { return _heap_calloc(gDefaultHeap, nmemb, size); }
OSI_WEAK void *realloc(void *ptr, unsigned size) { return _heap_realloc(gDefaultHeap, ptr, size); }
OSI_WEAK void free(void *ptr) { bootFree(ptr); }
